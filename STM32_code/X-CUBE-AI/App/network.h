...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "model_44_no_augmented"
...
#define AI_NETWORK_IN_1_CHANNEL     (1760)
#define AI_NETWORK_IN_1_SIZE        (1760)
#define AI_NETWORK_IN_1_SIZE_BYTES  (7040)
